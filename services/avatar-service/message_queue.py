"""
message_queue.py
RabbitMQ Consumer & Publisher cho Avatar Service
"""
...
class MessageQueueConsumer:
    """RabbitMQ Consumer - Nhận audio từ TTS service"""
...
class MessageQueuePublisher:
    """RabbitMQ Publisher - Đẩy video/frames sang OBS service"""
    ...
    async def publish(self, data: dict):
        ...
        Args:
            data: Dictionary chứa thông tin video/animation
        """
        if not self.channel:
